...
class ProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAddInvalidToken()
    {
        ...
        $this->setExpectedException(
            'Laminas\Config\Exception\InvalidArgumentException',
    ...
    public function testTranslator()
    {
        if (! class_exists(ExtensionNotLoadedException::class)) {
            $this->markTestSkipped(sprintf('%s skipped to allow testing against laminas-servicemanager v3', __FUNCTION__));
        }
